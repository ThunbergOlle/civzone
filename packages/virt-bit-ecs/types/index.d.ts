import { NetworkPacketData } from "@virtcon2/network-packet";

declare module '@virtcon2/virt-bit-ecs' {
  ...
  export type System<S> = (world: IWorld, state: S, new_packets: Array<NetworkPacketData<any>>) => { state: S; world: IWorld };
  ...
  export function addEntity<W extends IWorld = IWorld>(world: W, desiredEid: number = null): number;
  ...
  export function defineSystem<S>(update: (world: IWorld, state: S, new_packets: Array<NetworkPacketData<any>>) => W): System<S>;
