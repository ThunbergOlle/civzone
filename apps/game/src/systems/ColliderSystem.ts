      ...
      if (sprite) {
        ...
        if (collisionGroup) {
          try {
            ...
            console.error(e);
            console.log(
              `Failed to add collider for entity ${eid} with group ${Collider.group[eid]}. This is likely because the dynamic collider was added to static group or vice-versa`,
            );
          }
        }
      } else {
